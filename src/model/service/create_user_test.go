...
import (
	...
	"github.com/gporto95/crud-go/src/tests/mocks"
...
func TestUserDomainService_CreateUserServices(t *testing.T) {
	...
	t.Run("when_user_is_not_registred_returns_error", func(t *testing.T) {
		id := primitive.NewObjectID().Hex()
	...
	t.Run("when_user_is_registred_returns_success", func(t *testing.T) {
		id := primitive.NewObjectID().Hex()
