...
func TestUserRepository_FindUserByEmail(t *testing.T) {
	...
	mtestDb.Run("when_sending_a_valid_email_returns_success", func(mt *testing.T) {
	...
	mtestDb.Run("returns_error_when_mongodb_returns_error", func(mt *testing.T) {
	...
	mtestDb.Run("returns_no_document_found", func(mt *testing.T) {
		mt.AddMockResponses(mtest.CreateCursorResponse(
			0, 
